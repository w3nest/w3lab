...
The W3Nest server’s configuration file, which you can view [here](@nav/environment/yw-configuration), 
...
[Configuration](@nav/doc/api/w3nest/app/environment/models.models_config.Configuration). 
